...
- **Internal code-redundancy refactors** in `../CODE_CLEANUP.md` (its Phases 1–4)
  are not started. Do them only after active HPC runs finish, and add the
  regression tests it lists first.
